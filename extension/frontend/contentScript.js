...
const showImageDiscussionPanel = async (imageUrl, heatmap_image) => {
    ...
    heatmap_explanation.textContent = "The following heatmap has been generated by our deepfake detection model, explaining the salient features/characteristics present within the image that the model considered important whilst arriving at it's decision.";
