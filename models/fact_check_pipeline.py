...
flagged_text = "The Lakers are set to retire Luka Doncic’s jersey ahead of tonight’s matchup against the Mavericks."
flagged_url = ""
...
print(fact_check_completion.choices[0].message.content)
